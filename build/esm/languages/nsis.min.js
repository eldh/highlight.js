function nsis(e){var t={className:"variable",begin:/\$+\{[\w.:-]+\}/},n={
className:"variable",begin:/\$+\w+/,illegal:/\(\)\{\}/},i={className:"variable",
begin:/\$+\([\w^.:-]+\)/},l={className:"string",variants:[{begin:'"',end:'"'},{
...
beginKeywords:"Function PageEx Section SectionGroup",end:"$"},l,{
className:"keyword",
...
},{className:"class",begin:/\w+::\w+/},e.NUMBER_MODE]}}export default nsis;