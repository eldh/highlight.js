...
function qml(e){var n="[a-zA-Z_][a-zA-Z0-9\\._]*",r={className:"attribute",
begin:"\\bid\\s*:",starts:{className:"string",end:n,returnEnd:!1}},a={
begin:n+"\\s*:",returnBegin:!0,contains:[{className:"attribute",begin:n,
end:"\\s*:",excludeEnd:!0,relevance:0}],relevance:0},t={begin:concat(n,/\s*\{/),
...
begin:"\\."+e.IDENT_RE,relevance:0},r,a,t],illegal:/#/}}export default qml;