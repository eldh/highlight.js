function scheme(e){var t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n={$pattern:t,
...
contains:["self",a,i,r,s,l]}]},d={className:"name",begin:t,keywords:n},g={
variants:[{begin:"\\(",end:"\\)"},{begin:"\\[",end:"\\]"}],contains:[{
begin:/lambda/,endsWithParent:!0,returnBegin:!0,contains:[d,{begin:/\(/,
end:/\)/,endsParent:!0,contains:[s]}]},d,o]}
;return o.contains=[a,r,i,s,l,u,g].concat(c),{name:"Scheme",illegal:/\S/,
contains:[e.SHEBANG(),r,i,l,u,g].concat(c)}}export default scheme;