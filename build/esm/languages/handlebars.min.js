...
contains:[e.NUMBER_MODE,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,c]}}},d={
...
},m=e.inherit(l,{className:"name",keywords:n,starts:e.inherit(d,{end:/\)/})})
;c.contains=[m];const b=e.inherit(l,{keywords:n,className:"name",
starts:e.inherit(d,{end:/\}\}/})}),g=e.inherit(l,{keywords:n,className:"name"
}),u=e.inherit(l,{className:"name",keywords:n,starts:e.inherit(d,{end:/\}\}/})})
