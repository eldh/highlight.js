function hy(e){var a="a-zA-Z_\\-!.?+*=<>&#'",t="["+a+"]["+a+"0-9/;:]*",i={
$pattern:t,
...
endsWithParent:!0,relevance:0},h={keywords:i,className:"name",begin:t,starts:f
},g=[u,s,d,m,o,p,c,r,l,n]
;return u.contains=[e.COMMENT("comment",""),h,f],f.contains=g,c.contains=g,{
name:"Hy",aliases:["hylang"],illegal:/\S/,
contains:[e.SHEBANG(),u,s,d,m,o,p,c,r,l]}}export default hy;