function applescript(e){var t=e.inherit(e.QUOTE_STRING_MODE,{illegal:""}),r={
className:"params",begin:"\\(",end:"\\)",contains:["self",e.C_NUMBER_MODE,t]
},i=e.COMMENT("--","$"),a=[i,e.COMMENT("\\(\\*","\\*\\)",{contains:["self",i]
...
}].concat(a),illegal:"//|->|=>|\\[\\["}}export default applescript;