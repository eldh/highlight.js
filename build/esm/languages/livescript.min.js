...
;function livescript(e){var n={
keyword:KEYWORDS.concat(["then","unless","until","loop","of","by","when","and","or","is","isnt","not","it","that","otherwise","from","to","til","fallthrough","case","enum","native","list","map","__hasProp","__extends","__slice","__bind","__indexOf"]).join(" "),
literal:LITERALS.concat(["yes","no","on","off","it","that","void"]).join(" "),
built_in:BUILT_INS.concat(["npm","print"]).join(" ")
},a="[A-Za-z$_](?:-[0-9A-Za-z$_]|[0-9A-Za-z$_])*",t=e.inherit(e.TITLE_MODE,{
begin:a}),r={className:"subst",begin:/#\{/,end:/\}/,keywords:n},i={
className:"subst",begin:/#[A-Za-z$_]/,end:/(?:-[0-9A-Za-z$_]|[0-9A-Za-z$_])*/,
keywords:n},s=[e.BINARY_NUMBER_MODE,{className:"number",
...
contains:[r,e.HASH_COMMENT_MODE]},{begin:/\/(?![ *])(\\\/|.)*?\/[gim]*(?=\W)/}]
},{begin:"@"+a},{begin:"``",end:"``",excludeBegin:!0,excludeEnd:!0,
subLanguage:"javascript"}];r.contains=s;var o={className:"params",begin:"\\(",
returnBegin:!0,contains:[{begin:/\(/,end:/\)/,keywords:n,
contains:["self"].concat(s)}]};return{name:"LiveScript",aliases:["ls"],
keywords:n,illegal:/\/\*/,
contains:s.concat([e.COMMENT("\\/\\*","\\*\\/"),e.HASH_COMMENT_MODE,{
begin:"(#=>|=>|\\|>>|-?->|!->)"},{className:"function",contains:[t,o],
...
illegal:/[:="\[\]]/,contains:[t]},t]},{begin:a+":",end:":",returnBegin:!0,
returnEnd:!0,relevance:0}])}}export default livescript;