...
begin:"/(?!\\/)",end:"/[a-z]*"}]}],relevance:0},d=[r,l,b,{className:"regexp",
...
;return t.contains=d,r.contains=d.slice(1),{name:"Crystal",aliases:["cr"],
keywords:s,contains:d}}export default crystal;