function dts(e){var n={className:"string",
...
className:"symbol",begin:"^\\s*[a-zA-Z_][a-zA-Z\\d_]*:"},_={className:"params",
begin:"<",end:">",contains:[a,i]},r={className:"class",
...
contains:[i,d,l,r,_,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,a,n]
},i,d,l,r,_,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,a,n,s,{
begin:e.IDENT_RE+"::",keywords:""}]}}export default dts;