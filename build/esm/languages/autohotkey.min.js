function autohotkey(e){var a={begin:"`[\\s\\S]"};return{name:"AutoHotkey",
case_insensitive:!0,aliases:["ahk"],keywords:{
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}export default autohotkey;